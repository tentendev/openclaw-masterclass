---
title: SOUL.md 人格設定
description: 深入了解 OpenClaw 的 SOUL.md 人格系統——如何設計、撰寫與調優你的 AI 代理的性格、語氣與行為規範。
sidebar_position: 5
---
...
- [Top 50 必裝 Skills](/docs/top-50-skills/overview) — 為你的 AI 添加強大技能
- [安全性最佳實踐](/docs/security/best-practices) — 確保你的部署安全無虞
- [架構概覽](/docs/architecture/overview) — 深入理解 OpenClaw 的內部運作機制
